...
# "owner/repo" of the repo being reported on. Defaults to GITHUB_REPOSITORY
# (set automatically in Actions) but can point at a different repo, since
# this script may run from a separate automation repo.
